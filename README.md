...
With default settings, SFplusNPS plays on Android on the level of the very strong last SFNNv5 Stockfish, since the net-architecture was already in 2022 updated to SFNNv5 and recently to the latest net nn-e1fb1ade4432.nnue. Further updates are on the way. Note that development has moved to the [StockfishNPS repo branch](https://github.com/Joachim26/StockfishNPS/tree/Master_SFplusNPS). New releases will be also made [here](https://github.com/Joachim26/StockfishPlusNPS/releases) in this repo.
